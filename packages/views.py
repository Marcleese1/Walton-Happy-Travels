...
def checkout(request):
    new_booking = Bookings(
        bookingDate=request.session.get('Bookings.bookingDate'),
        bookingType=request.session.get('Bookings.bookingType'),
        bookingPayment=request.session.get('Bookings.bookingPayment'),
        bookingDeposit=request.session.get('Bookings.bookingDeposit'),
